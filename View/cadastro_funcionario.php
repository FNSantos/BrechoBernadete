                ...
                <div id="content">
                    ...
                    <div class="line_input">
                        ...
                        <div class="content_input" style="width:320px;">
                            ...
                            <input type="text" name="txt_cpf" id="txt_cpf" placeholder="Digite o CPF do funcionário." class="input_text" style="width:300px;">
                        </div>
                    </div>
                    <div class="line_input">
                        <div class="content_input" style="width: 250px;">
                            ...
                            <input type="text" name="txt_dt_nasc" id="txt_dt_nasc" placeholder="Ex: 22/09/18" class="input_text" style="width: 200px;">
                        </div>
                        <div class="content_input" style="width:320px;">
                            <div class="title_input">
                                Cargo
                    ...
                    <div class="line_input">
                        <div class="content_input">
                            ...
                            <input type="text" name="txt_email" id="txt_email" placeholder="Digite o e-mail do funcionário." class="input_text">
                        </div>
                        <div class="content_input" style="width:320px;">
                            <div class="title_input">
                                Celular
                            </div>
                            <input type="text" name="txt_celular" id="txt_celular" placeholder="Ex: 94356-7654" class="input_text" style="width:300px;">
                        </div>
                    </div>
                    <div class="line_input">
                        <div class="content_input">
                    ...
                    <div class="line_input">
                        ...
                        <div class="content_input" style="width:320px;">
                            ...
                            <input type="text" name="txt_cep" id="txt_cep" placeholder="CEP da residência." class="input_text" style="width:300px;">
                        </div>
                    </div>
                    <div class="line_input">
                    ...
                    <div class="line_input">
                        ...
                        <div class="content_input" style="width:350px;margin-left:0px;">
                            ...
                            <input type="text" name="txt_dt_contr" id="txt_dt_contr" placeholder="Ex: 12/08/18." class="input_text" style="width:200px;">
                        </div>
                    </div>
                    <div class="line_input">
